...
The site has one job: convert a visitor who was handed the link into a REQUEST ACCESS tap at https://app.vantaintel.ai/?join=1.
It never collects an email itself; the register form lives in the app. Until Stripe is live, every plan's action is REQUEST ACCESS.

Design source of truth: `DESIGN.md` at this root (byte-identical to the app repo's copy). Read it before touching any pixel, and verify every section by screenshot at 390 / 768 / 1024 / 1280 / 1600 before commit.
